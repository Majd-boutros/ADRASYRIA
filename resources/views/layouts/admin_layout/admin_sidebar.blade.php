...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{route('admin.dashboard')}}" class="brand-link">
        <img src="{{asset('images/logo.png')}}" alt="ADRA Logo" class="brand-image" style="opacity: .8">
        <br>
    </a>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item menu-open">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{route('get.carousel.images')}}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Carousel</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('get.impacts')}}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Impacts</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{route('get.projects')}}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Projects</p>
                            </a>
                        </li>
