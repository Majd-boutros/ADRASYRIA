...
@section('content')
    <div class="content-wrapper">
        ...
        <!-- /.card-header -->
            <!-- form start -->
            <form method="post" action="{{route('update.donor',$donor['id'])}}" enctype="multipart/form-data" name="postDonorForm" id="postDonorForm">
                @csrf
                <div class="card-body">
                    <div class="form-group">
                        <label for="name">Name</label>
                        <input type="text" name="name" id="name" value="{{$donor['name']}}" class="form-control" >
                    </div>
                    <div class="form-group">
